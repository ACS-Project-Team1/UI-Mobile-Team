...
export default function RegisterLeague() {
  ...
  const handleSelected = (value) => {
    if (value) {
      ...
      setSelectedTeamId(valueParsed?.teamId)
  ...
  const handleOnSubmit = async () => {
    try {
      await BaseRequest.post(`${BASE_URL}/leagues/joinLeague/${league_data?.leagueId}/${selectedteamId}`);
      navigation.navigate('Leaguesmain')
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.buttonContainer}>
        <CustomButton text="SUBMIT" color={Colors.theme} onPress={() => handleOnSubmit()} />
      </View>
